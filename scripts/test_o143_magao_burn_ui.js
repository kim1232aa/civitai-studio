...
assert.ok(
  html.includes("v0821o143-magao-burn-ui") || html.includes("v0821o144-adv-default-open") || html.includes("v0821o145-smart-match") || html.includes("v0821o146-canvas-hydrate-scope") || html.includes("v0821o147-house-first-after-import"),
  "html stamp o143 or successor"
);
assert.ok(
  /storyboard\.js\?v=o143burn|storyboard\.js\?v=o144adv|storyboard\.js\?v=o145match|storyboard\.js\?v=o146canvas|storyboard\.js\?v=o147house/.test(html),
