...
function harness(backend = "modelscope-ai") {
  ...
  const sandbox = {
    ...
    applyServiceConstraints() {}, nodeById() { return null; },
    lockHouse() {}, honorHouseLock() { return false; },
    hfHasLoras() { return false; },
    resolveFalLoraEndpointFromChips() { return null; },
    resolveHfLoraEndpointFromChips() { return null; },
    ensureFalLoraServiceSelected() {},
    ensureHfLoraServiceSelected() {},
    ensureMsLoraServiceSelected() {},
    looksCivitaiServiceId() { return false; },
    looksHfServiceId() { return false; },
    looksFalServiceId() { return false; },
