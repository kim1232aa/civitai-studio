...
assert.ok(html.includes("v0821o36-checkpoint-not-lora"), "html stamp o16");
assert.ok(html.includes("storyboard.js?v=20260910-o36checkpointnotlora"), "cache bust o16");
