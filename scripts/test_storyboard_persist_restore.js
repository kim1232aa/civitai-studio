...
assert.ok(html.includes("v0821o39-refs-fill-smart-match"), "html stamp o16");
assert.ok(html.includes("storyboard.js?v=20260910-o39refsfillsmartmatch"), "cache bust o16");
