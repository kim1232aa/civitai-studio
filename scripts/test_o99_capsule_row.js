...
assert.ok(js.includes("v0821o99-capsule-row") || js.includes("v0821o101-shell") || js.includes("v0821o100-desk") || js.includes("v0821o102-seko") || js.includes("v0821o103-wide-desk") || js.includes("v0821o104-seko-attach") || js.includes("v0821o105-adapt") || js.includes("v0821o106-drag") || js.includes("v0821o107-wires"), "js stamp");
assert.ok(html.includes("o99capsulerow") || html.includes("o101shell") || html.includes("o102seko") || html.includes("o103wide") || html.includes("o104attach") || html.includes("o105adapt") || html.includes("o106drag") || html.includes("o107wires"), "html stamp");
...
assert.ok(o67.includes("v0821o99-capsule-row") || o67.includes("v0821o100-desk") || o67.includes("v0821o101-shell") || o67.includes("v0821o102-seko") || o67.includes("v0821o103-wide-desk") || o67.includes("v0821o104-seko-attach") || o67.includes("v0821o105-adapt") || o67.includes("v0821o106-drag") || o67.includes("v0821o107-wires"), "o67 stamp");
