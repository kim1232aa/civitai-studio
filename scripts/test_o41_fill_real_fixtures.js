...
assert.ok(html.includes("v0821o49b-hydrate-fresh-empty-url"), "html stamp o41");
assert.ok(html.includes("storyboard.js?v=20260911-o49bhydratefreshemptyurl"), "cache bust o41");
