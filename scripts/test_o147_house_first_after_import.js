...
assert.ok(html.includes("v0821o147-house-first-after-import") || html.includes("o147house") || html.includes("v0821o148-magao-cn-catalog-tongyi") || html.includes("o148magao") || html.includes("v0821o150-nano-prompt-limit-warn") || html.includes("o150nano") || html.includes("v0821o152-nano-aspect-matches-size") || html.includes("o152nano"), "html stamp o147 or successor");
assert.ok(/storyboard\.js\?v=o147house|storyboard\.js\?v=o148magao|storyboard\.js\?v=o149bseed|storyboard\.js\?v=o150nano|storyboard\.js\?v=o151fal|storyboard\.js\?v=o152nano/.test(html), "cache bust o147+");
