...
assert.ok(html.includes("v0821o147-house-first-after-import") || html.includes("o147house"), "html stamp");
assert.ok(/storyboard\.js\?v=o147house/.test(html), "cache bust o147");
