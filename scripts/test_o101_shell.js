...
assert.ok(html.includes("o101shell") || html.includes("o102seko") || html.includes("o103wide") || html.includes("o104attach") || html.includes("o105adapt") || html.includes("o106drag") || html.includes("o107wires") || html.includes("o108unhide") || html.includes("o109room") || html.includes("o110ws"), "html stamp");
...
assert.ok(o67.includes("bottom\", \"12px\"") || o67.includes("v0821o102-seko") || o67.includes("v0821o103-wide-desk") || o67.includes("v0821o104-seko-attach") || o67.includes("v0821o105-adapt") || o67.includes("v0821o106-drag") || o67.includes("v0821o107-wires") || o67.includes("v0821o108-unhide") || o67.includes("v0821o109-room") || o67.includes("v0821o110-ws"), "pin is desk or seko capsule");
