...
assert.ok(js.includes("v0821o118-fix") || js.includes("v0821o117-nine") || js.includes("v0821o115-tools") || js.includes("v0821o114-full") || js.includes("v0821o113-seko") || js.includes("v0821o112-attach") || js.includes("v0821o110-ws"), "js stamp");
assert.ok(html.includes("o118fix") || html.includes("o117nine") || html.includes("o115tools") || html.includes("o114full") || html.includes("o113seko") || html.includes("o110ws") || html.includes("o112attach"), "html stamp");
