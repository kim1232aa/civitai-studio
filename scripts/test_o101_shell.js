...
assert.ok(js.includes("v0821o101-shell") || js.includes("v0821o102-seko"), "js stamp");
assert.ok(html.includes("o101shell") || html.includes("o102seko"), "html stamp");
...
assert.ok(o67.includes("bottom\", \"12px\"") || o67.includes("v0821o102-seko"), "pin is desk or seko capsule");
