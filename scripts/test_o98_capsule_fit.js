...
assert.ok(js.includes("v0821o98-capsule-fit") || js.includes("v0821o101-shell") || js.includes("v0821o102-seko") || js.includes("v0821o103-wide-desk"), "js stamp");
assert.ok(html.includes("o98capsulefit") || html.includes("o101shell") || html.includes("o102seko") || html.includes("o103wide"), "html stamp");
