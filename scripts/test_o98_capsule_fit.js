...
assert.ok(js.includes("v0821o98-capsule-fit") || js.includes("v0821o101-shell"), "js stamp");
assert.ok(html.includes("o98capsulefit") || html.includes("o101shell"), "html stamp");
