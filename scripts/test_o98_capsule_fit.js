...
assert.ok(js.includes("v0821o98-capsule-fit") || js.includes("v0821o101-shell") || js.includes("v0821o102-seko") || js.includes("v0821o103-wide-desk") || js.includes("v0821o104-seko-attach") || js.includes("v0821o105-adapt") || js.includes("v0821o106-drag") || js.includes("v0821o107-wires") || js.includes("v0821o108-unhide"), "js stamp");
assert.ok(html.includes("o98capsulefit") || html.includes("o101shell") || html.includes("o102seko") || html.includes("o103wide") || html.includes("o104attach") || html.includes("o105adapt") || html.includes("o106drag") || html.includes("o107wires") || html.includes("o108unhide"), "html stamp");
