...
def test_selbar_scoped_layout_skips_exclusive_outside_asset():
    ...
    assert_true("v0821o16-persist-skip-empty" in html, "stamp must be v0821o16-persist-skip-empty")
...
def test_empty_boot_no_robot_demo():
    ...
    assert_true("v0821o16-persist-skip-empty" in html, "html stamp")
...
def test_v0815_gen_hardgate():
    ...
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o16-persist-skip-empty" in html, "html stamp v0821o16-persist-skip-empty")
    assert_true("nl-storyboard-v0821n" in js, "STORE v0820c")
    assert_true("nl-storyboard-v0819b" in js, "STORE_OLDS has v0819b")
    assert_true("nl-storyboard-v0819" in js, "STORE_OLDS has v0819")
    assert_true("nl-storyboard-v0818" in js, "STORE_OLDS has v0818")
...
def test_v0815c_ref_cap_single_slot_and_overcap_block():
    ...
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o16-persist-skip-empty" in html, "stamp v0821o16-persist-skip-empty")
    assert_true("nl-storyboard-v0821n" in js, "STORE v0820c")
    assert_true("nl-storyboard-v0819b" in js, "STORE_OLDS has v0819b")
    assert_true("nl-storyboard-v0819" in js, "STORE_OLDS has v0819")
    assert_true("nl-storyboard-v0818" in js, "STORE_OLDS has v0818")
...
def test_v0817b_unmention_at_tag():
    """v0817b lineage under v0821o16-persist-skip-empty: unmention/link helpers still present."""
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o16-persist-skip-empty" in html, "html stamp")
    assert_true('const STORE = "nl-storyboard-v0821o16"' in js, "STORE v0820c")
...
def test_empty_prompt_on_new_shot_and_load_demo():
    """v0821o16-persist-skip-empty: loadDemo + btnAdd default prompt is empty; Skill template stays."""
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o16-persist-skip-empty" in html, "html stamp")
...
def test_v0821g_send_bind():
    """v0821o16-persist-skip-empty: always 首帧已就绪; addEventListener+pointerdown; hit/z-index; missing-frame bad."""
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o16-persist-skip-empty" in html, "html stamp")
    assert_true('class="stamp"' in html, ".stamp")
    assert_true("storyboard.js?v=20260910-r16perskip" in html, "js cache bust")
    assert_true('const STORE = "nl-storyboard-v0821o16"' in js, "STORE v0821h")
    assert_true('"nl-storyboard-v0821g"' in js, "STORE_OLDS keeps v0821g")
    assert_true('"nl-storyboard-v0821f"' in js, "STORE_OLDS keeps v0821f")
...
def test_v0821h_send_aria():
    """v0821o16-persist-skip-empty: gate via aria-disabled (not disabled=true); click setMsg on needFrame/stub; busy → 进行中."""
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o16-persist-skip-empty" in html, "html stamp")
    assert_true('class="stamp"' in html, ".stamp")
...
def test_v0821n4_js_cache_bust():
    ...
    assert_true('src="/static/storyboard.js?v=20260910-r16perskip"' in html, "script cache-bust")
...
def test_v0821n5_dock_scroll():
    ...
    assert_true('class="stamp"' in html, ".stamp")
    assert_true("storyboard.js?v=20260910-r16perskip" in html, "js cache bust")
    assert_true('src="/static/storyboard.js?v=20260910-r16perskip"' in html, "script ?v=")
...
def test_v0821o2_fal_turbo_pin():
    ...
    assert_true('class="stamp"' in html, ".stamp")
    assert_true("storyboard.js?v=20260910-r16perskip" in html, "js cache bust")
    assert_true('src="/static/storyboard.js?v=20260910-r16perskip"' in html, "cache-bust")
...
def test_v0821o6_modelscope_hub_lora():
    ...
    STAMP = "v0821o16-persist-skip-empty"
    HUB = "krea/Krea-2-Turbo"
...
def test_v0821o6b_ms_lora_shape():
    ...
    assert_true("v0821o16-persist-skip-empty" in html and "nano" not in "v0821o16-persist-skip-empty", "html must not drift onto Nano stamps")
    assert_true("v0821o16-persist-skip-empty" in html, "o7 param-surface stamp")
...
def test_v0821o7_param_surface():
    ...
    assert_true("v0821o16-persist-skip-empty" in html, "html stamp o7")
    assert_true('class="stamp"' in html, ".stamp")
    assert_true('src="/static/storyboard.js?v=20260910-r16perskip"' in html, "cache-bust")
    assert_true('const STORE = "nl-storyboard-v0821o16"' in js, "STORE o7")
    assert_true('"nl-storyboard-v0821o6b"' in js, "OLDS keeps o6b")
