...
def test_selbar_scoped_layout_skips_exclusive_outside_asset():
    ...
    assert_true("v0821o10-lora-null" in html, "stamp must be v0821o10-lora-null")
...
def test_empty_boot_no_robot_demo():
    ...
    assert_true("v0821o10-lora-null" in html, "html stamp")
...
def test_v0815_gen_hardgate():
    ...
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o10-lora-null" in html, "html stamp v0821o10-lora-null")
    assert_true("nl-storyboard-v0821n" in js, "STORE v0820c")
    assert_true("nl-storyboard-v0819b" in js, "STORE_OLDS has v0819b")
    assert_true("nl-storyboard-v0819" in js, "STORE_OLDS has v0819")
    assert_true("nl-storyboard-v0818" in js, "STORE_OLDS has v0818")
...
def test_v0815c_ref_cap_single_slot_and_overcap_block():
    ...
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o10-lora-null" in html, "stamp v0821o10-lora-null")
    assert_true("nl-storyboard-v0821n" in js, "STORE v0820c")
    assert_true("nl-storyboard-v0819b" in js, "STORE_OLDS has v0819b")
    assert_true("nl-storyboard-v0819" in js, "STORE_OLDS has v0819")
    assert_true("nl-storyboard-v0818" in js, "STORE_OLDS has v0818")
...
def test_v0817b_unmention_at_tag():
    """v0817b lineage under v0821o10-lora-null: unmention/link helpers still present."""
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o10-lora-null" in html, "html stamp")
    assert_true('const STORE = "nl-storyboard-v0821o7"' in js, "STORE v0820c")
...
def test_empty_prompt_on_new_shot_and_load_demo():
    """v0821o10-lora-null: loadDemo + btnAdd default prompt is empty; Skill template stays."""
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o10-lora-null" in html, "html stamp")
...
def test_v0821g_send_bind():
    """v0821o10-lora-null: always 首帧已就绪; addEventListener+pointerdown; hit/z-index; missing-frame bad."""
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o10-lora-null" in html, "html stamp")
    assert_true('class="stamp"' in html, ".stamp")
    assert_true("storyboard.js?v=20260910-r10lora" in html, "js cache bust")
    assert_true('const STORE = "nl-storyboard-v0821o7"' in js, "STORE v0821h")
    assert_true('"nl-storyboard-v0821g"' in js, "STORE_OLDS keeps v0821g")
    assert_true('"nl-storyboard-v0821f"' in js, "STORE_OLDS keeps v0821f")
...
def test_v0821h_send_aria():
    """v0821o10-lora-null: gate via aria-disabled (not disabled=true); click setMsg on needFrame/stub; busy → 进行中."""
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
    assert_true("v0821o10-lora-null" in html, "html stamp")
    assert_true('class="stamp"' in html, ".stamp")
...
def test_v0821n4_js_cache_bust():
    ...
    assert_true('src="/static/storyboard.js?v=20260910-r10lora"' in html, "script cache-bust")
...
def test_v0821n5_dock_scroll():
    ...
    assert_true('class="stamp"' in html, ".stamp")
    assert_true("storyboard.js?v=20260910-r10lora" in html, "js cache bust")
    assert_true('src="/static/storyboard.js?v=20260910-r10lora"' in html, "script ?v=")
...
def test_v0821o2_fal_turbo_pin():
    ...
    assert_true('class="stamp"' in html, ".stamp")
    assert_true("storyboard.js?v=20260910-r10lora" in html, "js cache bust")
    assert_true('src="/static/storyboard.js?v=20260910-r10lora"' in html, "cache-bust")
...
def test_v0821o6b_ms_lora_shape():
    ...
    assert_true("v0821o10-lora-null" in html, "o7 param-surface stamp")
...
def test_v0821o7_param_surface():
    ...
    assert_true("v0821o10-lora-null" in html, "html stamp o7")
    assert_true('class="stamp"' in html, ".stamp")
    assert_true('src="/static/storyboard.js?v=20260910-r10lora"' in html, "cache-bust")
    assert_true('const STORE = "nl-storyboard-v0821o7"' in js, "STORE o7")
    assert_true('"nl-storyboard-v0821o6b"' in js, "OLDS keeps o6b")
...
def test_v0821o9_fail_zh_lora_honesty():
    """Critiquito P0/P1: humanize Fal reject; Composer foot syncs card _error; LoRA 未填 outbound-honest; index+storyboard searchLoras no silent 0.8."""
    import json
    import subprocess
    js = (ROOT / "static" / "storyboard.js").read_text(encoding="utf-8")
    html = (ROOT / "static" / "storyboard.html").read_text(encoding="utf-8")
