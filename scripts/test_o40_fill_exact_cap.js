...
assert.ok(html.includes("v0821o46-resume-job-writeback"), "html stamp o41");
assert.ok(html.includes("storyboard.js?v=20260911-o46resumejobwriteback"), "cache bust o41");
