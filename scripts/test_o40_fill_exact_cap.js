...
assert.ok(html.includes("v0821o48-hydrate-server-wins"), "html stamp o41");
assert.ok(html.includes("storyboard.js?v=20260911-o48hydrateserverwins"), "cache bust o41");
