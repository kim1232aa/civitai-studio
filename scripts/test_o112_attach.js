...
assert.ok(js.includes("v0821o114-full") || js.includes("v0821o113-seko") || js.includes("v0821o112-attach"), "js stamp");
assert.ok(html.includes("o114full") || html.includes("o113seko") || html.includes("o112attach"), "html stamp");
