...
assert.ok(js.includes("v0821o93-search-match") || js.includes("v0821o94-cap-on-node"), "js stamp");
assert.ok(html.includes("o93searchmatch") || html.includes("o94caponnode"), "html stamp");
...
assert.ok(js.includes("v0821o94-cap-on-node"), "js o94 stamp");
