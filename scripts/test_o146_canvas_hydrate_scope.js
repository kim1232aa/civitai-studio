...
assert.ok(html.includes("v0821o146-canvas-hydrate-scope") || html.includes("o146canvas"), "html stamp");
assert.ok(/storyboard\.js\?v=o146canvas/.test(html), "cache bust o146");
