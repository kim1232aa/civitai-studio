...
assert.ok(html.includes("v0821o146-canvas-hydrate-scope") || html.includes("o146canvas") || html.includes("v0821o147-house-first-after-import") || html.includes("o147house") || html.includes("v0821o148-magao-cn-catalog-tongyi") || html.includes("o148magao") || html.includes("v0821o150-nano-prompt-limit-warn") || html.includes("o150nano"), "html stamp o146 or successor");
assert.ok(/storyboard\.js\?v=o146canvas|storyboard\.js\?v=o147house|storyboard\.js\?v=o148magao|storyboard\.js\?v=o149bseed|storyboard\.js\?v=o150nano/.test(html), "cache bust o146+");
